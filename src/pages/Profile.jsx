...
const Profile = () => {
 ...
 const handleUnlikeShow = async (movie)=>{
  ...
  return <>
    <div>
      <div>
        <img className="block  w-full h-[500px] object:cover" src="https://assets.nflxext.com/ffe/siteui/vlv3/5e16108c-fd30-46de-9bb8-0b4e1bbbc509/29d8d7d7-83cc-4b5f-aa9b-6fd4f68bfaa6/IN-en-20240205-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="" />
