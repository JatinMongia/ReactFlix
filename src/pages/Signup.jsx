...
const handleFormSubmit =async (e)=>{
  ...
  return <>
    <div className="w-full h-screen">
      <img className="hidden sm:block absolute w-full h-full object:cover" src="https://assets.nflxext.com/ffe/siteui/vlv3/5e16108c-fd30-46de-9bb8-0b4e1bbbc509/29d8d7d7-83cc-4b5f-aa9b-6fd4f68bfaa6/IN-en-20240205-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="" />
          ...
          <div className=" max-w-[320px] mx-auto py-16">
            ...
            <form onSubmit={handleFormSubmit} className="w-full flex flex-col py-4">
              ...
              <div className="flex justify-between items-center text-gray-600">
                <p>
                  <input type="checkbox" className="mr-2" checked={remberLogin} onChange={(e)=>{setremberLogin(!remberLogin)}} />Remember Me
                </p>
                <p>Need Help?</p>
              </div>
              <p className="my-4 ">
